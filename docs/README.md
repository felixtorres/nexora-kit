...
- **OpenAPI spec:** Available at `GET /v1/openapi.json` on a running instance
- **Example plugins:** See `examples/plugins/` in the repo
- **Helm chart:** See `deploy/helm/nexora-kit/` for Kubernetes deployment
